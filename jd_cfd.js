...
!(async () => {
  ...
  if (!res2) res2 = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/zhaozhanzhan/jsdelivrCDN@main/shareCodes/cfd.json')
...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    if ($.shareCodesArr[$.index - 1]) {
      ...
      $.newShareCodes = [ ...$.strMyShareIds, "7160B7C9A97AAF8DDE493E81134B7F093FDF11BDAC4AE2D892AF42E648EAE8A1"];
    }
